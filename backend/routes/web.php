...
Route::resource('/danh-muc-san-pham', ProductCatalogueController::class)->middleware('checklogin::class');
Route::post('/danh-muc-san-pham/{id}','ProductCatalogueController@update_product_catalogue');
Route::post('/danh-muc-san-pham/destroy/{id}','ProductCatalogueController@destroy_product_catalogue');
