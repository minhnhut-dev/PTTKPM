                    ...
                    <div class="tab-content">
                        <div class="tab-pane active container" id="home">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select class="form-control"  name="product_catalogues_id" style="background-image: none;" required>
                                        @foreach ($productCatalogues as  $productCatalogue)
                                            @if ($productCatalogue->id == $sp->product_catalogues_id)
                                                <option value="{{ $productCatalogue->id }}" selected> {{ $productCatalogue->name }} </option>
                                            @else
